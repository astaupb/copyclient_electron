...
Section ""
	...
	CreateShortCut "$SMPROGRAMS\AStA Uni Paderborn\AStA Copyclient.lnk" "$INSTDIR\asta-copyclient-app.exe" ""
	CreateShortCut "$SMPROGRAMS\AStA Uni Paderborn\Deinstallieren.lnk" "$INSTDIR\uninstall.exe" ""
	CreateShortCut "$DESKTOP\AStA Copyclient.lnk" "$INSTDIR\asta-copyclient-app.exe" ""
	CreateShortCut "$SMSTARTUP\AStA Copyclient.lnk" "$INSTDIR\asta-copyclient-app.exe" ""
...
Section "Uninstall"
	...
	Exec '"$WINDIR\System32\taskkill.exe" /f /im asta-copyclient-app.exe'
	Delete "$INSTDIR\uninstall.exe"
	Delete "$INSTDIR\asta-copyclient-app.exe"
